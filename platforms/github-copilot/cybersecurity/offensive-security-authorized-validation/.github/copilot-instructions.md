# github-copilot Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `github-copilot/cybersecurity/offensive-security-authorized-validation/`.
