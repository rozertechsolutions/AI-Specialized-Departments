# github-copilot Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `github-copilot/cybersecurity/incident-response-dfir-recovery/`.
