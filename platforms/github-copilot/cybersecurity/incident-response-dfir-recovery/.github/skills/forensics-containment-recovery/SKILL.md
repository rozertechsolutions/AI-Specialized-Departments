...
description: Complete Incident Response, DFIR, and Recovery procedure for Forensics Containment Recovery; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---
...
Use this Skill for Incident Response, DFIR, and Recovery work involving Forensics Containment Recovery. It covers these professional workflows when relevant: incident-readiness review, incident triage and declaration support, active-incident coordination plan, evidence-preservation plan, forensic-acquisition plan, containment and eradication options, secure-recovery plan, ransomware coordination, data-exposure coordination, tabletop exercise, post-incident review.
