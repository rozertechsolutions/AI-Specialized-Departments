# claude-code Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `claude-code/cybersecurity/cyber-resilience-specialized-technologies/`.
