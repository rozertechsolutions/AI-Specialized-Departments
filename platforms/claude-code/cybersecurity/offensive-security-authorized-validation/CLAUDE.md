# claude-code Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `claude-code/cybersecurity/offensive-security-authorized-validation/`.
