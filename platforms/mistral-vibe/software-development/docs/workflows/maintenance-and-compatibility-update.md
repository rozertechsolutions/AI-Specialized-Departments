...
Perform maintenance while preserving supported environments, contracts, and fallback paths.
...
- compatibility evidence across affected surfaces
- fallback or rollback path
- documentation of unsupported or unverified environments
