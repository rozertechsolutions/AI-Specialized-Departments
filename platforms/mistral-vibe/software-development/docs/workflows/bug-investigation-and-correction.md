...
Reproduce, isolate, correct, and verify a defect without masking the symptom.
...
- observable symptom and affected versions, paths, or configurations
- reproduction steps or an explicit statement that reproduction is unavailable
- root-cause explanation tied to code or configuration evidence
- minimal correction that addresses the cause rather than suppressing the symptom
- regression evidence and remaining uncertainty
