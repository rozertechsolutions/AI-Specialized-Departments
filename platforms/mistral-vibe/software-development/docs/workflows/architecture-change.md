...
Change architecture only with alternatives, decision evidence, migration controls, and independent approval.
...
- decision record with context, alternatives, and trade-offs
- affected boundaries, contracts, data flows, and ownership
- migration stages with compatibility and rollback strategy
- risk review for security, reliability, data integrity, and operational impact
- independent architecture approval before close
