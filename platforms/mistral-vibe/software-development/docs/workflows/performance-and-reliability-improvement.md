...
Improve performance or resilience from a baseline or documented absence of one.
...
- observed baseline or explicit absence of measurement
- hypothesis tied to resource, concurrency, failure, or data-integrity analysis
- correctness guardrails that prevent performance-only regressions
- measurement or validation evidence
- regression and operational risk assessment
