...
description: Complete Security Architecture and Engineering procedure for Security Architecture Governance; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---
...
Use this Skill for Security Architecture and Engineering work involving Security Architecture Governance. It covers these professional workflows when relevant: security architecture review, reference architecture design, identity and privileged-access architecture review, cloud and platform review, network segmentation review, data-protection and cryptography review, container, Kubernetes, and IaC review, security-control pattern design, architecture-remediation validation.
...
2. Confirm this Skill is the right owner for the requested Security Architecture and Engineering output and identify any required handoff to another cybersecurity area.
...
Verify platform-native compatibility for mistral-vibe, professional coverage, evidence traceability, no unsupported tool claims, no self-review, no circular delegation, no secrets, no live-action claim, no fabricated validation, and no hidden residual risk.
