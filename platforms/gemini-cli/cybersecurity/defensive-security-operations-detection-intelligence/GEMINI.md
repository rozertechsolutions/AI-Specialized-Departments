# gemini-cli Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `gemini-cli/cybersecurity/defensive-security-operations-detection-intelligence/`.
