# gemini-cli Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `gemini-cli/cybersecurity/application-product-devsecops-security/`.
