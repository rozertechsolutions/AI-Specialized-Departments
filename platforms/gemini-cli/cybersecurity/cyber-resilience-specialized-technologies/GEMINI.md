# gemini-cli Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `gemini-cli/cybersecurity/cyber-resilience-specialized-technologies/`.
