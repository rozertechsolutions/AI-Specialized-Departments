---
name: soc-telemetry-governance
description: Reusable Defensive Security Operations, Detection, and Intelligence procedure for soc telemetry governance using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Defensive Security Operations, Detection, and Intelligence work related to soc telemetry governance, including the applicable workflows: SOC operating-model review, telemetry-source onboarding design, detection design and review, supplied-alert triage, threat-hunt planning, threat-intelligence assessment, defensive malware-analysis planning, SOAR playbook design, detection-coverage assessment, SOC quality review, incident escalation.
...
---
name: detection-triage-hunting
description: Reusable Defensive Security Operations, Detection, and Intelligence procedure for detection triage hunting using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Defensive Security Operations, Detection, and Intelligence work related to detection triage hunting, including the applicable workflows: SOC operating-model review, telemetry-source onboarding design, detection design and review, supplied-alert triage, threat-hunt planning, threat-intelligence assessment, defensive malware-analysis planning, SOAR playbook design, detection-coverage assessment, SOC quality review, incident escalation.
...
---
name: intelligence-malware-automation
description: Reusable Defensive Security Operations, Detection, and Intelligence procedure for intelligence malware automation using static evidence, human approval gates, and independent review.
---

# Intelligence Malware Automation

## Use Cases

Use this Skill for Defensive Security Operations, Detection, and Intelligence work related to intelligence malware automation, including the applicable workflows: SOC operating-model review, telemetry-source onboarding design, detection design and review, supplied-alert triage, threat-hunt planning, threat-intelligence assessment, defensive malware-analysis planning, SOAR playbook design, detection-coverage assessment, SOC quality review, incident escalation.
...
---
name: incident-escalation-handoff
description: Reusable Defensive Security Operations, Detection, and Intelligence procedure for incident escalation handoff using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Defensive Security Operations, Detection, and Intelligence work related to incident escalation handoff, including the applicable workflows: SOC operating-model review, telemetry-source onboarding design, detection design and review, supplied-alert triage, threat-hunt planning, threat-intelligence assessment, defensive malware-analysis planning, SOAR playbook design, detection-coverage assessment, SOC quality review, incident escalation.
