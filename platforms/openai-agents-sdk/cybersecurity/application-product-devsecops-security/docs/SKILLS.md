---
name: secure-sdlc-review
description: Reusable Application, Product, and DevSecOps Security procedure for secure sdlc review using static evidence, human approval gates, and independent review.
---
...
description: Reusable Application, Product, and DevSecOps Security procedure for secure design code review using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Application, Product, and DevSecOps Security work related to secure design code review, including the applicable workflows: secure-SDLC review, threat modeling, application design review, static secure-code review, dependency and supply-chain review, CI/CD review, finding triage, release-readiness assessment, product-vulnerability coordination, remediation validation.
...
---
name: supply-chain-ci-release-review
description: Reusable Application, Product, and DevSecOps Security procedure for supply chain ci release review using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Application, Product, and DevSecOps Security work related to supply chain ci release review, including the applicable workflows: secure-SDLC review, threat modeling, application design review, static secure-code review, dependency and supply-chain review, CI/CD review, finding triage, release-readiness assessment, product-vulnerability coordination, remediation validation.
...
---
name: testing-findings-psirt-assurance
description: Reusable Application, Product, and DevSecOps Security procedure for testing findings psirt assurance using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Application, Product, and DevSecOps Security work related to testing findings psirt assurance, including the applicable workflows: secure-SDLC review, threat modeling, application design review, static secure-code review, dependency and supply-chain review, CI/CD review, finding triage, release-readiness assessment, product-vulnerability coordination, remediation validation.
