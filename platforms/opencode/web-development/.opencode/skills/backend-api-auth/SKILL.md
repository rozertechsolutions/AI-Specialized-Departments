...
## OpenCode invocation
Load this Skill through OpenCode's native `skill` tool for scoped backend, API, authentication, session, persistence, validation, authorization, or server-side behavior work.
