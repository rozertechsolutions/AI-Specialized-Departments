...
This is the authoritative safety and authority policy for the ChatGPT Software Development manual package.
...
Repository files in this package are static source material. They are not automatically loaded by ChatGPT. Project content may be copied into a ChatGPT Project. Custom GPTs, Skills, Workspace Agents, apps, and connectors depend on account plan, workspace policy, administrator enablement, and current product availability.
## Operational Notes
