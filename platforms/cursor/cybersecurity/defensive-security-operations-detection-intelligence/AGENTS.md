# cursor Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `cursor/cybersecurity/defensive-security-operations-detection-intelligence/`.
