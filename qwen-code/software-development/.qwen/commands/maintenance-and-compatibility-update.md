---
description: Maintain compatibility across supported environments, contracts, migrations, deprecations, data/config implications, and fallback.
---
...
Maintain compatibility across supported environments, contracts, migrations, deprecations, data/config implications, and fallback.

## Workflow-specific gates

- supported environments and contracts
- compatibility matrix
- migrations
- deprecations
- data and configuration implications
- fallback
