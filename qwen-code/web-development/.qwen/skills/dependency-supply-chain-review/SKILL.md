...
Load this Skill through Qwen Code Agent Skills when dependencies, lockfiles, third-party scripts, SDKs, build plugins, or CDN assets are proposed or changed. Do not install packages from this Skill.
