...
Product surface: Qwen Code QWEN.md/AGENTS.md guidance, Skills, subagents, commands, hooks, MCP, extensions, and approval fields where supported.
...
Qwen Code installed and workspace trusted; provider credentials configured outside repository only by a human.
...
Open Qwen Code from qwen-code/cybersecurity/<area>/ and use QWEN.md, AGENTS.md, and native subagent/skill/command folders. Keep approval conservative.
...
Qwen Code discovers documented instruction and extension locations from the working directory. Skills and subagents remain area-local and require supported native paths.
...
- `governance-risk-compliance-assurance/`: `QWEN.md`, `AGENTS.md`, `.qwen/`
- `security-architecture-engineering/`: `QWEN.md`, `AGENTS.md`, `.qwen/`
- `application-product-devsecops-security/`: `QWEN.md`, `AGENTS.md`, `.qwen/`
- `exposure-vulnerability-hardening/`: `QWEN.md`, `AGENTS.md`, `.qwen/`
- `defensive-security-operations-detection-intelligence/`: `AGENTS.md`, `.qwen/`
- `incident-response-dfir-recovery/`: `QWEN.md`, `AGENTS.md`, `.qwen/`
- `offensive-security-authorized-validation/`: `QWEN.md`, `AGENTS.md`, `.qwen/`
- `cyber-resilience-specialized-technologies/`: `QWEN.md`, `AGENTS.md`, `.qwen/`
