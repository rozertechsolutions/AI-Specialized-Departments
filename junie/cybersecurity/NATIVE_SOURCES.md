...
- https://plugins.jetbrains.com/plugin/26104-junie

Validation method:

- Inventory of `junie/cybersecurity/` files and native support directories.
...
- Project paths: `junie/cybersecurity/<area>/` for all eight Cybersecurity areas.
