# kilo-code Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `kilo-code/cybersecurity/security-architecture-engineering/`.
