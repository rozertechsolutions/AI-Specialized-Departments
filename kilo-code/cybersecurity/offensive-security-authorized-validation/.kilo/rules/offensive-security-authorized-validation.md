# kilo-code Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `kilo-code/cybersecurity/offensive-security-authorized-validation/`.
