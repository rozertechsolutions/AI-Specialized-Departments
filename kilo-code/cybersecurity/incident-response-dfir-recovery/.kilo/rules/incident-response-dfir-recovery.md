# kilo-code Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `kilo-code/cybersecurity/incident-response-dfir-recovery/`.
