# kilo-code Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `kilo-code/cybersecurity/application-product-devsecops-security/`.
