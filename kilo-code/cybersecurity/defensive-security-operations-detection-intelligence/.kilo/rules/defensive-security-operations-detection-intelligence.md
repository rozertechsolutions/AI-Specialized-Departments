# kilo-code Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `kilo-code/cybersecurity/defensive-security-operations-detection-intelligence/`.
