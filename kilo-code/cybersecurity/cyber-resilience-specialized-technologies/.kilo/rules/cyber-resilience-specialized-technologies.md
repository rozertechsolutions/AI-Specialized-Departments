# kilo-code Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `kilo-code/cybersecurity/cyber-resilience-specialized-technologies/`.
