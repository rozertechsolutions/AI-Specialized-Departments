...
description: Complete Cyber Resilience and Specialized Technologies procedure for Assurance Transition Governance; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---
...
2. Confirm this Skill is the right owner for the requested Cyber Resilience and Specialized Technologies output and identify any required handoff to another cybersecurity area.
...
Verify platform-native compatibility for github-copilot, professional coverage, evidence traceability, no unsupported tool claims, no self-review, no circular delegation, no secrets, no live-action claim, no fabricated validation, and no hidden residual risk.
