# github-copilot Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `github-copilot/cybersecurity/defensive-security-operations-detection-intelligence/`.
