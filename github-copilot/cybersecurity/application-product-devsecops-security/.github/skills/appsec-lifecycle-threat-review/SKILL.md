---
name: appsec-lifecycle-threat-review
description: Complete Application, Product, and DevSecOps Security procedure for Appsec Lifecycle Threat Review; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---

# Appsec Lifecycle Threat Review

## Use Cases

Use this Skill for Application, Product, and DevSecOps Security work involving Appsec Lifecycle Threat Review. It covers these professional workflows when relevant: secure-SDLC review, threat modeling, application design review, static secure-code review, dependency and supply-chain review, CI/CD review, finding triage, release-readiness assessment, product-vulnerability coordination, remediation validation.
