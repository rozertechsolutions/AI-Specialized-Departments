# github-copilot Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `github-copilot/cybersecurity/application-product-devsecops-security/`.
