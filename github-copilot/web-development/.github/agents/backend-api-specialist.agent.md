...
## Invocation boundary
Select directly for server behavior, API contracts, validation, auth/session, persistence, integrations, errors, or observability. Do not use for browser-only presentation work.
