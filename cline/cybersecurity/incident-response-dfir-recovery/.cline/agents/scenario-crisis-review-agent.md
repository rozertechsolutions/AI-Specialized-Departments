...
- Tool and file permissions: read-only by default; any repository edit must remain inside `cline/cybersecurity/incident-response-dfir-recovery/` and require the user task to explicitly call for static artifact updates.
