...
## OpenCode invocation
Load this Skill through OpenCode's native `skill` tool for scoped frontend planning or implementation after stack, acceptance criteria, and approval boundaries are clear.
