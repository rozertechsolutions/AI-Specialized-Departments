...
## OpenCode invocation
Load this Skill through OpenCode's native `skill` tool for material web architecture, rendering, interface, data-flow, migration, rollback, or integration decisions.
