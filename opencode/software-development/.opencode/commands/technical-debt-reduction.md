---
description: Reduce prioritized debt within a bounded scope while preserving behavior and preventing unrelated cleanup.
---
...
Reduce prioritized debt within a bounded scope while preserving behavior and preventing unrelated cleanup.

## Workflow-specific gates

- identified debt and impact
- prioritization rationale
- bounded scope
- preserved behavior
- measurable improvement
- prevention of unrelated cleanup
