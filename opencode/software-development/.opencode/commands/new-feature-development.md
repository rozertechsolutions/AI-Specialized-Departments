---
description: Deliver a new capability through validated requirements, architecture fit, implementation slices, integration evidence, and feature documentation.
---
