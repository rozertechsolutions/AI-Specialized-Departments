...
description: Complete Defensive Security Operations, Detection, and Intelligence procedure for Detection Triage Hunting; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---
...
Use this Skill for Defensive Security Operations, Detection, and Intelligence work involving Detection Triage Hunting. It covers these professional workflows when relevant: SOC operating-model review, telemetry-source onboarding design, detection design and review, supplied-alert triage, threat-hunt planning, threat-intelligence assessment, defensive malware-analysis planning, SOAR playbook design, detection-coverage assessment, SOC quality review, incident escalation.
...
2. Confirm this Skill is the right owner for the requested Defensive Security Operations, Detection, and Intelligence output and identify any required handoff to another cybersecurity area.
