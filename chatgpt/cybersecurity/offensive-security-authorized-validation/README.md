...
This artifact belongs to `chatgpt/cybersecurity/offensive-security-authorized-validation/` and supports static Offensive Security Authorized Validation work only. It is a repository-authored instruction artifact and is not executed during validation or implementation.
