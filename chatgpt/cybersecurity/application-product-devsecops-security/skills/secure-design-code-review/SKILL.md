...
description: Complete Application, Product, and DevSecOps Security procedure for Secure Design Code Review; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---
...
Use this Skill for Application, Product, and DevSecOps Security work involving Secure Design Code Review. It covers these professional workflows when relevant: secure-SDLC review, threat modeling, application design review, static secure-code review, dependency and supply-chain review, CI/CD review, finding triage, release-readiness assessment, product-vulnerability coordination, remediation validation.
