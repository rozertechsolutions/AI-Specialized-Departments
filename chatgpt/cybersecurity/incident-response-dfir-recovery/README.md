...
This artifact belongs to `chatgpt/cybersecurity/incident-response-dfir-recovery/` and supports static Incident Response, DFIR, and Recovery work only. It is a repository-authored instruction artifact and is not executed during validation or implementation.

## Purpose

Preserve professional coverage for: incident-readiness review, incident triage and declaration support, active-incident coordination plan, evidence-preservation plan, forensic-acquisition plan, containment and eradication options, secure-recovery plan, ransomware coordination, data-exposure coordination, tabletop exercise, post-incident review.
