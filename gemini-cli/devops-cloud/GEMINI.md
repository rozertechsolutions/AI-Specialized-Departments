...
## Native resources
Gemini CLI loads hierarchical memory from `GEMINI.md`. Agent files and skills are static project guidance and must not execute shell commands or extensions for this section.
