# gemini-cli Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `gemini-cli/cybersecurity/offensive-security-authorized-validation/`.
