# gemini-cli Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `gemini-cli/cybersecurity/incident-response-dfir-recovery/`.
