...
Inputs: completed artifact, source evidence list, assumptions, limitations, decision needed, owner, reviewer, approver, residual risk, and completion criteria.
...
Outputs: independent review note, finding list, evidence gaps, required corrections, approval-readiness statement, residual risk concerns, and human-only decisions.

Stop conditions: request to approve, accept, close, publish, deploy, change production, or self-review.
