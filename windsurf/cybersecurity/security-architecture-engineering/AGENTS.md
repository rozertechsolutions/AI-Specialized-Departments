# windsurf Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `windsurf/cybersecurity/security-architecture-engineering/`.
