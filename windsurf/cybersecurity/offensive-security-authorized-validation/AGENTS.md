# windsurf Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `windsurf/cybersecurity/offensive-security-authorized-validation/`.
