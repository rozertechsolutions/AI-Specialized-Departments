# windsurf Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `windsurf/cybersecurity/cyber-resilience-specialized-technologies/`.
...
- Native in this package: AGENTS.md scoped instructions, workspace Skills, and the scoped Devin Local permission policy. Cascade Workflows are omitted because the selected surface is Devin Local.
