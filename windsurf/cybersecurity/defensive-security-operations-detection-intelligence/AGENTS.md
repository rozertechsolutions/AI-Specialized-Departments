# windsurf Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `windsurf/cybersecurity/defensive-security-operations-detection-intelligence/`.
