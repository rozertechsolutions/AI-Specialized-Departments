# windsurf Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `windsurf/cybersecurity/incident-response-dfir-recovery/`.
