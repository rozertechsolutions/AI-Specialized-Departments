# windsurf Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `windsurf/cybersecurity/application-product-devsecops-security/`.
