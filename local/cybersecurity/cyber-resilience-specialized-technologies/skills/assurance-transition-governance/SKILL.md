...
Verify platform-native compatibility for local, professional coverage, evidence traceability, no unsupported tool claims, no self-review, no circular delegation, no secrets, no live-action claim, no fabricated validation, and no hidden residual risk.
