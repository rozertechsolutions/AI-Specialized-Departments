...
AREA_SLUG = 'defensive-security-operations-detection-intelligence'
...
ROLE_SPECS = [{'description': 'Own SOC operating model, service boundaries, escalation, telemetry requirements, '
                 'and logging coverage.',
  'name': 'soc-governance-telemetry-agent',
  'read_only': False},
 {'description': 'Own detection lifecycle, supplied-alert triage, case-analysis methods, '
                 'threat-hunt design, and coverage mapping.',
  'name': 'detection-triage-hunting-agent',
  'read_only': False},
 {'description': 'Own threat-intelligence assessments, defensive malware-analysis planning, and '
                 'SOAR playbook design with approval gates.',
  'name': 'intelligence-malware-automation-agent',
  'read_only': False},
 {'description': 'Own SOC metrics, detection quality, adversary-behavior mapping, and independent '
                 'quality review.',
  'name': 'coverage-quality-assurance-agent',
  'read_only': False},
 {'description': 'Independently review escalation handoffs and ensure declared incidents transfer '
                 'to incident response.',
  'name': 'incident-escalation-reviewer',
  'read_only': True}]
WORKFLOW_SPECS = ('SOC operating-model review',
