...
description: Reusable Security Architecture and Engineering procedure for security architecture review using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Security Architecture and Engineering work related to security architecture review, including the applicable workflows: security architecture review, reference architecture design, identity and privileged-access architecture review, cloud and platform review, network segmentation review, data-protection and cryptography review, container, Kubernetes, and IaC review, security-control pattern design, architecture-remediation validation.
...
description: Reusable Security Architecture and Engineering procedure for identity cloud network data design using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Security Architecture and Engineering work related to identity cloud network data design, including the applicable workflows: security architecture review, reference architecture design, identity and privileged-access architecture review, cloud and platform review, network segmentation review, data-protection and cryptography review, container, Kubernetes, and IaC review, security-control pattern design, architecture-remediation validation.
...
description: Reusable Security Architecture and Engineering procedure for container iac automation review using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Security Architecture and Engineering work related to container iac automation review, including the applicable workflows: security architecture review, reference architecture design, identity and privileged-access architecture review, cloud and platform review, network segmentation review, data-protection and cryptography review, container, Kubernetes, and IaC review, security-control pattern design, architecture-remediation validation.
...
description: Reusable Security Architecture and Engineering procedure for independent architecture assurance using static evidence, human approval gates, and independent review.
---
...
Use this Skill for Security Architecture and Engineering work related to independent architecture assurance, including the applicable workflows: security architecture review, reference architecture design, identity and privileged-access architecture review, cloud and platform review, network segmentation review, data-protection and cryptography review, container, Kubernetes, and IaC review, security-control pattern design, architecture-remediation validation.
