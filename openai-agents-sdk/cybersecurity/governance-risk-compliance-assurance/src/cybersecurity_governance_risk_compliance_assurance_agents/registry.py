...
AREA_SLUG = 'governance-risk-compliance-assurance'
...
ROLE_SPECS = [{'description': 'Own governance, policy lifecycle, control governance, framework mapping, '
                 'compliance gap assessment, and change impact.',
  'name': 'governance-policy-frameworks-agent',
  'read_only': False},
 {'description': 'Own cyber risk records, exception packages, treatment options, residual-risk '
                 'wording, and remediation governance.',
  'name': 'cyber-risk-exceptions-agent',
  'read_only': False},
 {'description': 'Own assurance evidence requests, evidence quality review, control validation '
                 'support, findings, and remediation closure packages.',
  'name': 'assurance-evidence-remediation-agent',
  'read_only': False},
 {'description': 'Own supplier cyber risk, maturity assessment, metrics, dashboards, and executive '
                 'reporting.',
 ...
 {'description': 'Independently review high-impact GRC outputs without creating or approving them.',
  ...
  'read_only': True}]
WORKFLOW_SPECS = ('governance review',
 'policy review',
