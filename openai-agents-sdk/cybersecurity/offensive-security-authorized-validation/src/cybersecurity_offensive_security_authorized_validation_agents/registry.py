...
AREA_SLUG = 'offensive-security-authorized-validation'
...
ROLE_SPECS = [{'description': 'Own written authorization, exact scope, rules of engagement, assessment '
                 'planning, exclusions, dates, and emergency stop.',
  'name': 'authorization-assessment-planning-agent',
  'read_only': False},
 {'description': 'Own adversary-emulation, red-team, purple-team, control-validation, BAS, and '
                 'social-engineering assessment planning.',
  'name': 'emulation-purple-safety-agent',
  'read_only': False},
 {'description': 'Own finding quality, evidence, severity, confidence, cleanup assurance, '
                 'authorized retest planning, and remediation validation.',
  'name': 'findings-retest-assurance-agent',
  'read_only': False},
 {'description': 'Own white-team deconfliction, safety, communications, emergency stop, and '
                 'artifact-control planning.',
  'name': 'white-team-deconfliction-agent',
  'read_only': False},
 {'description': 'Independently review scope, authorization, safety, report quality, and retest '
                 'readiness.',
  'name': 'independent-offensive-safety-reviewer',
  'read_only': True}]
WORKFLOW_SPECS = ('authorization and scoping',
