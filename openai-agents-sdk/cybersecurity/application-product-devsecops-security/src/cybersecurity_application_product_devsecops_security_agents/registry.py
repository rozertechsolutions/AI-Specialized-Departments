...
ROLE_SPECS = [{'description': 'Own secure SDLC governance, security requirements, release gates, and '
                 'product-security operating model.',
  'name': 'product-security-governance-agent',
  'read_only': False},
 {'description': 'Own requirements, threat models, abuse cases, mitigations, validation criteria, '
                 'and traceability.',
  'name': 'requirements-threat-modeling-agent',
  'read_only': False},
 {'description': 'Own application, API, web, mobile, backend, distributed-design, and static '
                 'secure-code review guidance.',
  'name': 'secure-design-code-review-agent',
  'read_only': False},
 {'description': 'Own dependency, SBOM, provenance, build, artifact, CI/CD, configuration, and '
                 'release-security review.',
  'name': 'supply-chain-ci-release-agent',
  'read_only': False},
 {'description': 'Own testing governance, finding triage, PSIRT coordination, remediation '
                 'guidance, and validation planning.',
  'name': 'testing-findings-psirt-agent',
  'read_only': False},
 {'description': 'Independently review high-impact application-security outputs and '
                 'release-readiness packages.',
  'name': 'independent-appsec-reviewer',
  'read_only': True}]
WORKFLOW_SPECS = ('secure-SDLC review',
 'threat modeling',
