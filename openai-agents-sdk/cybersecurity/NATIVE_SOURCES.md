...
- Inventory of `openai-agents-sdk/cybersecurity/` files and native support directories.
...
- Project paths: `openai-agents-sdk/cybersecurity/<area>/` for all eight Cybersecurity areas.
