...
AREA_SLUG = 'cyber-resilience-specialized-technologies'
...
ROLE_SPECS = [{'description': 'Own resilience strategy, critical services, dependencies, disruption scenarios, '
                 'backup, restoration, immutability, ransomware resilience, and recovery exercise '
                 'planning.',
  'name': 'resilience-recovery-core-agent',
  'read_only': False},
 {'description': 'Own OT/ICS, IoT, embedded, AI, machine-learning, agent, retrieval, memory, '
                 'model-supply-chain, hardware, and firmware security review.',
  'name': 'specialized-technology-review-agent',
  'read_only': False},
 {'description': 'Own cryptographic agility, post-quantum transition planning, '
                 'critical-infrastructure, and safety-relevant cybersecurity analysis.',
  'name': 'crypto-critical-infrastructure-agent',
  'read_only': False},
 {'description': 'Own corrective actions, resilience roadmap, specialist handoffs, transition '
 ...
 {'description': 'Independently review high-impact resilience and specialized-technology outputs.',
  ...
  'read_only': True}]
WORKFLOW_SPECS = ('cyber-resilience program review',
