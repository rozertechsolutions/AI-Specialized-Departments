# cursor Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `cursor/cybersecurity/security-architecture-engineering/`.
