# cursor Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `cursor/cybersecurity/cyber-resilience-specialized-technologies/`.
