# cursor Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `cursor/cybersecurity/application-product-devsecops-security/`.
