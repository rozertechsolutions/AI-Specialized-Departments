# cursor Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `cursor/cybersecurity/offensive-security-authorized-validation/`.
