# cursor Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `cursor/cybersecurity/incident-response-dfir-recovery/`.
