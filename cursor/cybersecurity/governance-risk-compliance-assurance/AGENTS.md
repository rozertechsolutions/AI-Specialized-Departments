# cursor Cybersecurity Governance, Risk, Compliance, and Assurance Instructions

These instructions apply only inside `cursor/cybersecurity/governance-risk-compliance-assurance/`.
