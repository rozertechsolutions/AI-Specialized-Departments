...
## Invocation boundary
Invoke directly from the calling Cursor Agent session after user-facing changes or when accessibility, responsive behavior, performance, resilience, metadata, or SEO evidence is required. Do not invoke to implement fixes.
