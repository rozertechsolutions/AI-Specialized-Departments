...
Aggregate readiness evidence for a human release decision without releasing anything.
...
- acceptance evidence and independent review outcomes
- unresolved defects, risks, and checks not run
- documentation, changelog, migration, and compatibility readiness
- artifact and version implications
- rollback readiness and explicit stop before publication, deployment, signing, or release
