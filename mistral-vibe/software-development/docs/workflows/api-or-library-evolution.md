...
Evolve a public contract with consumer impact, compatibility, versioning, migration, and examples.
...
- consumer impact and affected contracts or schemas
- source, binary, behavioral, and configuration compatibility
- versioning, deprecation, and migration plan
