...
Deliver a new capability from validated requirements through implementation evidence, independent review, and documentation.
...
- incremental implementation slices with integration evidence
- feature-specific documentation and migration notes when needed

## Risk triggers

- unclear requested behavior
- new trust boundary
- new dependency
- public behavior or API change
