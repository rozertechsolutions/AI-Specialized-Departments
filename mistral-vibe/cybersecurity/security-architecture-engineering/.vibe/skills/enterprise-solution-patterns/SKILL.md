...
description: Complete Security Architecture and Engineering procedure for Enterprise Solution Patterns; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---
...
Use this Skill for Security Architecture and Engineering work involving Enterprise Solution Patterns. It covers these professional workflows when relevant: security architecture review, reference architecture design, identity and privileged-access architecture review, cloud and platform review, network segmentation review, data-protection and cryptography review, container, Kubernetes, and IaC review, security-control pattern design, architecture-remediation validation.
