...
- Tool and file permissions: read-only by default; any repository edit must remain inside `mistral-vibe/cybersecurity/offensive-security-authorized-validation/` and require the user task to explicitly call for static artifact updates.
