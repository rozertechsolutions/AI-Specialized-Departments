...
## Native resources
Use `.codex/agents/*.toml` for role delegation and `.agents/skills/leadership-architecture/SKILL.md` for reusable section procedures. Do not configure active MCP servers for this section.
