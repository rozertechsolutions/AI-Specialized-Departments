# claude-code Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `claude-code/cybersecurity/incident-response-dfir-recovery/`.
