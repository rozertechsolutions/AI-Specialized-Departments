---
name: assurance-third-party-and-reporting
description: Complete Governance, Risk, Compliance, and Assurance procedure for Assurance Third Party And Reporting; uses supplied static evidence, explicit human approval gates, and independent review before high-impact conclusions.
---
...
Use this Skill for Governance, Risk, Compliance, and Assurance work involving Assurance Third Party And Reporting. It covers these professional workflows when relevant: governance review, policy review, cyber-risk assessment, risk-register maintenance, control mapping and gap assessment, evidence validation, third-party assessment, exception management, remediation closure review, maturity assessment, executive reporting, framework-change impact assessment.
...
2. Confirm this Skill is the right owner for the requested Governance, Risk, Compliance, and Assurance output and identify any required handoff to another cybersecurity area.
...
Verify platform-native compatibility for claude-code, professional coverage, evidence traceability, no unsupported tool claims, no self-review, no circular delegation, no secrets, no live-action claim, no fabricated validation, and no hidden residual risk.
