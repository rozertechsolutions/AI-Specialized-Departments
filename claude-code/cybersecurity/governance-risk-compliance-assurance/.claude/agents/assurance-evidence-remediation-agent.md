...
- Tool and file permissions: read-only by default; any repository edit must remain inside `claude-code/cybersecurity/governance-risk-compliance-assurance/` and require the user task to explicitly call for static artifact updates.
