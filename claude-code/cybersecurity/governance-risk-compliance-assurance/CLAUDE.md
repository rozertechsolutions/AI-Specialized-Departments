# claude-code Cybersecurity Governance, Risk, Compliance, and Assurance Instructions

These instructions apply only inside `claude-code/cybersecurity/governance-risk-compliance-assurance/`.
