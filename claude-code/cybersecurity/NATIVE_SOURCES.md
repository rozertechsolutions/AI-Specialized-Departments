...
- Inventory of `claude-code/cybersecurity/` files and native support directories.
...
- Project paths: `claude-code/cybersecurity/<area>/` for all eight Cybersecurity areas.
