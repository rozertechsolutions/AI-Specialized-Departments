# claude-code Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `claude-code/cybersecurity/defensive-security-operations-detection-intelligence/`.
