# claude-code Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `claude-code/cybersecurity/security-architecture-engineering/`.
