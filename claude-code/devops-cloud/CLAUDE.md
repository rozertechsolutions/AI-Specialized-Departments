...
## Native resources
Use `.claude/agents/` for the two section roles and `.claude/skills/` for reusable section 01 procedures. Workflow documents are static references and must not be run as scripts.
