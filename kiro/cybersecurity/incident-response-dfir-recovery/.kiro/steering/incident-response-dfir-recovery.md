# kiro Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `kiro/cybersecurity/incident-response-dfir-recovery/`.
