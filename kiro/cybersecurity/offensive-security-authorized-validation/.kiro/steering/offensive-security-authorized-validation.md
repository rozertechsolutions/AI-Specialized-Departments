# kiro Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `kiro/cybersecurity/offensive-security-authorized-validation/`.
