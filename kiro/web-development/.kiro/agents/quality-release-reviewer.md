...
## Invocation boundary
Use as a Kiro subagent after implementation and applicable specialist reviews. Do not use to perform release actions.
...
7. Do not launch subagents. Return the final verdict to the main agent.
